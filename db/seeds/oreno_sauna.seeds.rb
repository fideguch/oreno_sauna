...
{ sauna_name: "かるまる", man_sauna_temp: 90, man_water_temp: 7.9, woman_not_exist: true },
...
{ area_name: '入谷', sauna: Sauna.find_by(id: 5) },
...
{ sauna_rate: 100, water_bath_rate: 100, title: "こんなにいいサウナなかなかない", sauna: "data", saunner: "data" },
{ sauna_rate: 100, water_bath_rate: 100, title: "水風呂気持ちいいです", sauna: "data", saunner: "data" }
]

reports.each do |report|
	report[:sauna] = Sauna.find_by(id: rand(1..11))
